...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '10c0d103aecc809fbf29e614cc396d43',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.tianguoguo.fun', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/tian-guo-guo/NotionNext/refs/heads/main/public/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://api.dujin.org/bing/1920.php', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  ...
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE || 2, // post counts per page
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || '4PU6YGYPC4', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || 'd38cd88737fd00aa973009c8a0656ea9', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY:
    process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || '060b4246bbed8cc1af65c880727532f1', // 客户端搜索用的KEY
  ALGOLIA_INDEX: process.env.NEXT_PUBLIC_ALGOLIA_INDEX || 'TianguoguoBlogApp', // 在Algolia中创建一个index用作数据库
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || '1vfJpOoB8udhXuoRW6Dib',
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '360829211', // 对应歌单的 id 60198
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'codeva-poE157NOuh', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-3D4BMZEKS9', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-8880783902448292', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
